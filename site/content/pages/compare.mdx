---
title: Typespun compared to the alternatives
description: An honest comparison of Typespun with t3-env, envalid, plain Zod, node-config and manual process.env parsing — including the cases where Typespun is the wrong choice.
---
