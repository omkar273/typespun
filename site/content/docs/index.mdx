...
description: Install Typespun, scaffold a configuration declaration with typespun init, generate the loader, and see the exact console output of the first run and the first validation failure.
---
