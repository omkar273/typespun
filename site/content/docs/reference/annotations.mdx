---
title: Decorators and annotations
description: The six markers Typespun reads at build time — Config, Default, Env, Key, Secret and Ignore — in both their JSDoc form for interfaces and their inert decorator form for classes.
---
