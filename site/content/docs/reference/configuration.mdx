---
title: typespun.json reference
description: Every key accepted by typespun.json — input, output, tsconfig, envPrefix, defaults and secretDefaults — plus the conventional paths used when the file is absent.
---
