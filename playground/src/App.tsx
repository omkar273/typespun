...
import type { EnvEntry } from './components/LiveRun';
import LiveRun from './components/LiveRun';
import SchemaTable from './components/SchemaTable';
import { DEFAULT_ENV_PREFIX, PRESETS, SAMPLE_SOURCE } from './sample';
...
const THEME_KEY = 'typespun-playground-theme';
      ...
      <header className="topbar">
        <div className="brand">
          <span className="brand-mark">
            type<span>spun</span>/playground
          </span>
        ...
        <div className="topbar-tools">
          <div className="prefix-field">
            ...
            <input
              ...
              spellCheck={false}
              onChange={(event) =>
                setEnvPrefix(event.target.value.replace(/[^\w]/g, '').toUpperCase())
              }
            />
          </div>
          <button
      ...
      <main className="workbench">
        <section className="pane editor-pane">
          ...
          <div className="pane-body">
            <Suspense fallback={<div className="empty">Opening the editor…</div>}>
              <CodeEditor
                value={source}
                path="config.ts"
                theme={theme}
